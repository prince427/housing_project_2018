...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <div class="content three_quarter">
            ...
            <h1>Salford Council Design and planning</h1>
            <p>Searching keyword: 'Development' within all JSON files available for Salford on gov.uk</p>
            ...
            <script type="text/javascript">
                ...
                function loadMore(city){
                    ...
                    xmlhttp.open('POST', 'salford_design_engagement_curl.php', true);
                    xmlhttp.send(data);
                }
