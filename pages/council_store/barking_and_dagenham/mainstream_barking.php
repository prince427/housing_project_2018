    ...
    <main class="hoc container clear">
        ...
        <div class="sidebar one_quarter first">
            ...
            <div class="sdb_holder">
                ...
                <address>
                    Barking and Dagenham Borough Council<br>
                    ??<br>
                    1 Town Square<br>
                    London <br>
                    IG11 7LU<br>
        ...
        <div class="content three_quarter">
            ...
            <h1>Barking and Dagenham London Borough Council Regeneration</h1>
            <p> This page contains media publications based on Barking and Dagenham and its regeneration<p>
            ...
            <div id="media">
                <?php
                // URL to the JSON using Rengeneration AND Barking as keywords.
                $json = file_get_contents("https://content.guardianapis.com/search?q=regeneration%20AND%20barking&from-date=2014-01-01&api-key=2c0e1a7c-7fcc-4a0f-a15e-73ee51d1e665");
