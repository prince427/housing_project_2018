...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <div class="sidebar one_quarter first">
            ...
            <nav class="sdb_holder">
                <ul>
                    ...
                    <li><a href="/housing_project_2018/pages/council_store/glasgow/regeneration_stages/all_json.php">All available JSON files</a></li>
        ...
        <div class="content three_quarter">
            ...
            <h1>Glasgow Council Design and planning</h1>
            <p>Searching keyword: 'Development' within all JSON files available for Glasgow on gov.uk</p>
            ...
            <script type="text/javascript">
                ...
                function loadMore(city){
                    ...
                    xmlhttp.open('POST', 'glasgow_design_engagement_curl.php', true);
                    xmlhttp.send(data);
                }
