...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <div class="sidebar one_quarter first">
            ...
            <nav class="sdb_holder">
                <ul>
                    ...
                    <li><a href="/housing_project_2018/pages/council_store/barnet/regeneration_stages/all_json.php">All available JSON files</a></li>
        ...
        <div class="content three_quarter">
            ...
            <h1>Barnet Council Pre-plan consultation</h1>
            <p>Searching keyword: 'Consultation' within all JSON files available for Barnet on gov.uk</p>
            ...
            <script type="text/javascript">
                ...
                function loadMore(city){
                    ...
                    xmlhttp.open('POST', 'barnet_engagement_curl.php', true);
                    xmlhttp.send(data);
                }
