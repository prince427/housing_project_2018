...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <div class="content three_quarter">
            ...
            <h1>Scarborough Council Pre-plan consultation</h1>
            <p>Searching keyword: 'Consultation' within all JSON files available for Scarborough on gov.uk</p>
            ...
            <script type="text/javascript">
                ...
                function loadMore(city) {
                    ...
                    xmlhttp.open('POST', 'scarborough_engagement_curl.php', true);
                    xmlhttp.send(data);
                }
