    ...
    <main class="hoc container clear">
        ...
        <div class="sidebar one_quarter first">
            ...
            <nav class="sdb_holder">
                <ul>
                    <li><a href="scarborough_mainstream.php">Main-Stream Media</a></li>
                    <li><a href="regeneration_stages/all_json.php">All available JSON files</a></li>
                    <li><a href="regeneration_stages/scarborough_resident_engagement.php">Pre-Plan Consultation</a></li>
                    <li><a href="regeneration_stages/scarborough_design_and_planning.php">Design and Planning</a></li>
                </ul>
            </nav>
        ...
        <div class="content three_quarter">
            ...
            <p> This page contains media publications based on Scarborough and its regeneration</p>
            ...
            <div id="media">
                <?php
                // URL to the JSON using Rengeneration AND scarborough as keywords.
                $json = file_get_contents("https://content.guardianapis.com/search?q=regeneration%20AND%20scarborough&from-date=2014-01-01&api-key=2c0e1a7c-7fcc-4a0f-a15e-73ee51d1e665");
