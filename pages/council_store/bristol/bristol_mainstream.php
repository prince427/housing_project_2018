...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <div class="content three_quarter">
            ...
            <p> This page contains media publications based on Bristol and its regeneration<p>
            ...
            <div id="media">
                <?php
                // URL to the JSON using Rengeneration AND Bristol as keywords.
                $json = file_get_contents("https://content.guardianapis.com/search?q=regeneration%20AND%20bristol&from-date=2014-01-01&api-key=2c0e1a7c-7fcc-4a0f-a15e-73ee51d1e665");
