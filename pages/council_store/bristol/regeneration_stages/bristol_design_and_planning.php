...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <div class="content three_quarter">
            ...
            <h1>Bristol Council Design and planning</h1>
            <p>Searching keyword: 'Development' within all JSON files available for Bristol on gov.uk</p>
            ...
            $json = file_get_contents("https://www.gov.uk/api/search.json?q=bristol&start=$incrementURL");
            ...
            <script type="text/javascript">
                ...
                function loadMore(city){
                    ...
                    xmlhttp.open('POST', 'bristol_design_engagement_curl.php', true);
                    xmlhttp.send(data);
                }
